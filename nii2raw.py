...
def nii_raw(img1, img2, img3, lobe, save_path):
    ...
    img_arr_1[img_arr_lobe == 1] = 450
    img_arr_1[img_arr_lobe == 2] = 460
    img_arr_1[img_arr_lobe == 3] = 470
...
if __name__ == '__main__':
    img_1_path = r'F:\segment_registration\segmentation\26_30\026\CT3_clean_hu.nii.gz'  # CT
    img_2_path = r'F:\segment_registration\segmentation\26_30\026\CT3_av.nii.gz'  # 动静脉
    img_3_path = r'F:\segment_registration\segmentation\26_30\026\CT3_airway.nii.gz'  # 气道树
    lobe_path = r'F:\segment_registration\segmentation\26_30\026\CT3_lobe_mask.nii.gz'  # 肺叶
